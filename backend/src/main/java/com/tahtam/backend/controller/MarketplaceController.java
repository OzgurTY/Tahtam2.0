...
public class MarketplaceController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateMarketplace(@PathVariable String id, @RequestBody Marketplace marketplaceDetails) {
        try {
            Marketplace updatedMarketplace = marketplaceService.updateMarketplace(id, marketplaceDetails);
